        ...
        return (
            <div className="tokyo-school-wrapper">
                <div className="tokyo-school-container">
                    ...
                    <p className="tokyo-text">Looking for a ramen school in Tokyo? Look no further than the RaJuku. The RaJuku brings together some of Tokyo's most revered ramen chefs for two kinds of classes. One is a simple, one-day experience and the other is an intensive, in-depth 15 days of ramen study.</p>
                    <h3 className="tokyo-school-paragraph-intro">1-Day Course (4 hours)</h3>
                    <p className="tokyo-text">You'll learn a classic shoyu ramen from the Jiraigen Syndicate (check out their Saikoro shop <Link to="/blogpost/281" className="tokyo-school-link">here</Link>). Soup, tare seasoning, and toppings are all covered in this class, and at the end you'll plate your own bowl of classic Tokyo-style ramen. You can get a good idea of this class here:</p>
                    <div className="tokyo-school-video-wrapper">
                    <iframe className="tokyo-school-video" src="https://www.youtube.com/embed/o1lBdQFGFMQ" frameBorder="0" allowFullScreen title="ramen lesson at Tokyo ramen school"></iframe>
                    </div>
                    <p className="tokyo-text">The school is located near Fuchinobe Station, about one hour from central Tokyo. The costs are listed below. More people can join for half price. Please email me at <a className="tokyo-school-link" href="mailto:ramenamerican@gmail.com" target="_blank" rel="noopener noreferrer">ramenamerican@gmail.com</a> and I will put you in touch with the school.</p>
                    <h3 className="tokyo-school-paragraph-intro">15-Day Authentic Ramen Course</h3>
                    <p className="tokyo-text">Looking for something serious, something that will give you the foundation to understand and create your own ramen? The Rajuku's 15-day authentic ramen course brings some of Tokyo's best chefs together to teach you everything from recipes to shop management to ingedient sourcing. You'll have instruction from Koitani-san (<Link to="/blogpost/281" className="tokyo-school-link">Saikoro</ Link>), Yamaguchi-san (<Link to="/blogpost/394" className="tokyo-school-link">Yamaguchi</ Link>), Uchida-san (<Link to="/blogpost/104" className="tokyo-school-link">Hajime</ Link>), Aoki-san (logo designer), and others. These are some of Tokyo's ramen heavyweights, with countless accolades (Top 10 rankings, Michelin Guide recommended shops, many media appearances).</p>
                    <p className="tokyo-text">More details can be found <a className="tokyo-school-link" href="http://ramenschool.jp/ramenadventures/" target="_blank" rel="noopener noreferrer">here</a>. Essentially, it is five days of foundation study and business, followed by seven days of application and practice, and a final three days of developing your original style.</p>
                    <p className="tokyo-text">The cost for this class is 496,800 yen, plus 15,000 yen each day for translation services. Additional people can join for a nominal fee. Lodging at the school is available.</p>
                    <p className="tokyo-text">Please email me at <a className="tokyo-school-link" href="mailto:ramenamerican@gmail.com" target="_blank" rel="noopener noreferrer">ramenamerican@gmail.com</a> with any questions about this oppurtunity</p>
                </div>
            </div>
        );
    }
